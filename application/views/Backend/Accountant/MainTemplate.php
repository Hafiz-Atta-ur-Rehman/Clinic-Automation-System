			...
			<div class="scrollbar-inner sidebar-wrapper">
				...
				<ul class="nav">
					<li class="nav-item @provide(dashboardselected)">
						<a href="<?= base_url('index.php/accountant/dashboard');?>">
					...
					<li class="nav-item @provide(payrolllistselected)">
						<a href="<?= base_url('index.php/accountant/payroll');?>">
					...
					<li class="nav-item @provide(profileselected)">
						<a href="<?= base_url('index.php/accountant/profile');?>">
					...
					<li class="nav-item @provide(addinvoiceselected)">
						<a href="<?= base_url('index.php/accountant/add_invoice');?>">
					...
					<li class="nav-item @provide(manageinvoiceselected)">
						<a href="<?= base_url('index.php/accountant/manage_invoice');?>">
