                ...
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                        <div style="margin:10px;">
                            <a href="<?= base_url('index.php/Pharmacist/addmedicine') ?>">
                                <button type="button" class="btn btn-w-m btn-primary">+ Add Medicine</button>
                            </a>
                        </div>
                    </div>
                </div>
                            ...
                            <tbody>
                                ...
                                <td style="display: flex; justify-content: center;" class="sorting_1">
                                    ...
                                    <td style="text-align: center;">
                                        <div class="label label-success" style="font-size: 11px;">Available</div>
                                    </td>
                                    <td style="text-align: center;">
                                    <div class="form-group">
                                            <div class="col-lg-offset-2 col-lg-10">
                                                <a href="http://localhost/Clinic-Automation-system/index.php/Pharmacist/addmedicine">
