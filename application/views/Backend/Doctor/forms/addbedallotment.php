...
<div class="row animated fadeInDown">
    <div class="col-lg-10 col-md-10 col-xs-10 col-xs-offset-1 col-md-offset-1 col-lg-offset-1">
        ...
        <div class="form-group"><label class="col-lg-2 control-label">Bed Number</label>
                <div class="col-lg-10">
                    <select name="bed_id" data-placeholder="Choose a Country..." class="chosen-select" required>
        ...
        <div class="form-group"><label class="col-lg-2 control-label">Select Patient</label>
            ...
            <div class="form-group" id="data_1">
                ...
                <div class="col-lg-10">
                    <div class="input-group date">
                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input type="text" name="allotment_time" required="required" class="form-control" value="<?= isset($_POST['allotment_time']) ? $_POST['allotment_time'] : $records->allotment_time; ?>">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group" id="data_1">
                ...
                <div class="col-lg-10">
                    <div class="input-group date">
                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input type="text" name="discharge_time" required="required" class="form-control" value="<?= isset($_POST['discharge_time']) ? $_POST['discharge_time'] : $records->discharge_time; ?>">
                    </div>
                </div>
            </div>
