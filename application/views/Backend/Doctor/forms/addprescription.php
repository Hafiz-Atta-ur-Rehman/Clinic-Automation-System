    ...
    <div class="col-lg-10 col-md-10 col-xs-10 col-xs-offset-1 col-md-offset-1 col-lg-offset-1">
        <form class="form-horizontal" method="post" action="<?= site_url('index.php/doctor/manage_prescriptions'); ?>">
            ...
            <div class="form-group"><label class="col-lg-2 control-label">Time</label>
                <div class="col-lg-10">
                    <div class="input-group">
                        <input type="time" required value="<?= isset($_POST['time']) ? $_POST['time'] : $record->time; ?>" class="form-control" name="time">
            ...
            <div class="form-group"><label class="col-lg-2 control-label">Select Patient</label>
                <div class="col-lg-10">
                    <select name="patient_id" data-placeholder="Choose a Country..." required class="chosen-select" tabindex="2">
                ...
                <div class="col-lg-10">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content no-padding">
                            <textarea name="case_history" class="summernote">
                ...
                <div class="col-lg-10">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content no-padding">
                            ...
                            <textarea name="meditation" class="summernote">
                ...
                <div class="col-lg-10">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content no-padding">
                            ...
                            <textarea name="note" class="summernote">
