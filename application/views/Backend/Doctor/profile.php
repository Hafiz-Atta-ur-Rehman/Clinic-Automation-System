                ...
                <div id="tab-1" class="tab-pane active">
                    <div class="panel-body">
                        <div class="col-lg-10 col-md-10 col-xs-10 col-xs-offset-1 col-md-offset-1 col-lg-offset-1">
                            <form role="form" class="form-horizontal form-groups" action="<?= site_url('index.php/doctor/manage_profile') ?>" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label for="field-1" class="col-sm-3 control-label">Name</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="name" class="form-control" id="field-1" value="<?= isset($_POST['name']) ? $_POST['name'] : $data->name; ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="email" name="email" class="form-control" id="field-1" value="<?= isset($_POST['email']) ? $_POST['email'] : $data->email; ?>" required="">
                                        <div class="text-danger d-block text-bold">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea name="address" class="form-control " id="field-ta"><?= isset($_POST['address']) ? $_POST['address'] : $data->address; ?></textarea>
                                        <div class="text-danger d-block text-bold">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="number" name="phone" class="form-control" id="field-1" value="<?= isset($_POST['phone']) ? $_POST['phone'] : $data->phone; ?>">
                                        <div class="text-danger d-block text-bold">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <div class="text-danger d-block text-bold">
                                            <p style="padding-left: 2px;padding-top: 2px"><?= form_error('profile');?></p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label for="field-1" class="col-sm-3 control-label">
                                        Social Links</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="fb_link" value="<?= isset($_POST['fb_link']) ? $_POST['fb_link'] : $data->fb_link; ?>">
                                        <span class="description">Facebook Profile Link</span>
                                        <br>
                                        <input type="text" class="form-control" name="twitter_link" value="<?= isset($_POST['twitter_link']) ? $_POST['twitter_link'] : $data->twitter_link; ?>">
                                        <span class="description">Twitter Profile Link</span>
                                        <br>
                                        <input type="text" class="form-control" name="googleplus_link" value="<?= isset($_POST['googleplus_link']) ? $_POST['googleplus_link'] : $data->googleplus_link; ?>">
                                        <span class="description">Google Plus Link</span>
                                        <br>
                                        <input type="text" class="form-control" name="Linkedin_link" value="<?= isset($_POST['Linkedin_link']) ? $_POST['Linkedin_link'] : $data->Linkedin_link; ?>">
            ...
            <input type="hidden" id="old_img_1" name="old_img" value="<?= $d; ?>">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <div class="text-danger d-block text-bold">
                                            <p style="padding-left: 2px;padding-top: 2px"><?= $_GET['upload_errors'];?></p>
                                        </div>
                                        <?php endif; ?>
                                ...
                                <input type="hidden" name="hidden_id" value="<?= isset($data->profile_id) ? $data->profile_id : $data->hidden_id ?>">
                ...
                <div id="tab-2" class="tab-pane">
                    <div class="panel-body">
                        <div class="col-lg-10 col-md-10 col-xs-10 col-xs-offset-1 col-md-offset-1 col-lg-offset-1">
                            <form role="form" class="form-horizontal form-groups" action="<?= site_url('index.php/doctor/edit_password'); ?>" method="post">

                                <div class="form-group">
                                    <label for="field-1" class="col-sm-3 control-label">Old Password</label>

                                    <div class="col-sm-9">
                                        <input type="text" name="current_pass" class="form-control" id="field-1" value="<?= isset($_POST['current_pass']) ? $_POST['current_pass'] : ''; ?>" required="">
                                        <div class="text-danger d-block text-bold">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="password" name="new_pass" class="form-control" id="field-1" value="" required="">
                                        <div class="text-danger d-block text-bold">
                                            <p style="padding-left: 2px;padding-top: 2px"><?= form_error('new_pass');?></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="password" name="conf_pass" class="form-control" id="field-1" value="" required="">
                                        <div class="text-danger d-block text-bold">
                                            <p style="padding-left: 2px;padding-top: 2px"><?= form_error('conf_pass');?></p>
                                        </div>
                                    </div>
                                </div>
