            ...
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
                        ...
                        <div class="dropdown profile-element"> <span>
                            ...
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear"> <span class="block m-t-xs"> <strong class="font-bold"><?= $this->Admin_model->getdoctorby_id($_SESSION['PROFILE_ID'])->name; ?></strong>
                                    </span> <span class="text-muted text-xs block">Doctor</span> </span> </a>
                        </div>
                    ...
                    <li class="@provide(requestedappointmentsselected)">
                        <a href="<?= base_url('index.php/doctor/requested_appointment') ?>"><span class="nav-label">Requested Appointments</span> </a>
                    </li>
                    </li>
