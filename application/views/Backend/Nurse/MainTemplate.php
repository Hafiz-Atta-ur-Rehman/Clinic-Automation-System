            ...
            <div class="mdc-drawer__content">
                ...
                <div class="mdc-list-group">
                    <nav class="mdc-list mdc-drawer-menu">
                        ...
                        <div class="mdc-list-item mdc-drawer-item">
                            <a class="mdc-drawer-link" href="<?= base_url('index.php/Nurse/patient') ?>">
                                ...
                                <nav class="mdc-list mdc-drawer-submenu">
                                    <div class="mdc-list-item mdc-drawer-item">
                                        <a class="mdc-drawer-link"
                                            href="<?= base_url('index.php/Nurse/managebed') ?>">
                                            Manage Bed
                                        </a>
                                    </div>
                                    <div class="mdc-list-item mdc-drawer-item">
                        ...
                        <div class="mdc-list-item mdc-drawer-item">
                            ...
                            <div class="mdc-expansion-panel" id="sample-page-submenu">
                                <nav class="mdc-list mdc-drawer-submenu">
                                    <div class="mdc-list-item mdc-drawer-item">
                                        <a class="mdc-drawer-link" href="<?= base_url('index.php/Nurse/managebloodbank') ?>">
                                            Manage Blood Bank
                                        </a>
                                    </div>
                                    <div class="mdc-list-item mdc-drawer-item">
                        ...
                        <div class="mdc-list-item mdc-drawer-item">
                            <a class="mdc-drawer-link" href="<?= base_url('index.php/Nurse/payroll') ?>">
                                <i class="material-icons mdc-list-item__start-detail mdc-drawer-item-icon"
            ...
            <header class="mdc-top-app-bar">
                <div class="mdc-top-app-bar__row">
                    <div class="mdc-top-app-bar__section mdc-top-app-bar__section--align-start">
                        ...
                        <span class="mdc-top-app-bar__title">CAS</span><span>
                            <font color="purple;">
                                <h4>@provide(title)</h4>
                            </font>
                        </span>
                                ...
                                <ul class="mdc-list" role="menu" aria-hidden="true" aria-orientation="vertical">
                                    <li class="mdc-list-item" role="menuitem">
                                        ...
                                        <div
                                            ...
                                            <a href="<?= base_url('index.php/nurse/profile') ?>">
