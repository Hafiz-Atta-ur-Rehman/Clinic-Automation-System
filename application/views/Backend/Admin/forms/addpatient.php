    ...
    <div class="card-body">
        <form role="form" action="<?= site_url('index.php/admin/manage_patients');?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <div class="col-12 col-md-7">
                    <input type="date" class="form-control" id="birthday" name="birth_date" value="<?php echo isset($record->birth_date) ? $record->birth_date : set_value('birth_date');?>">
                    <div class="invalid-feedback text-danger d-block text-bold">
            ...
            <div class="form-group row">
                ...
                <div class="col-12 col-md-7">
                    <input type="number" class="form-control" id="birthday" name="age" value="<?php echo isset($record->age) ? $record->age : set_value('age');?>">
                    <div class="invalid-feedback text-danger d-block text-bold">
                        <?= form_error('age'); ?>
                    </div>
                </div>
