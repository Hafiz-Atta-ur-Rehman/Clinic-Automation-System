    ...
    <div class="card-body">
        <form role="form" action="<?= site_url('index.php/admin/manage_doctors'); ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <div class="col-12 col-md-7">
                    <textarea name="profile" required class="textarea" placeholder="Place some text here" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">
            ...
            <div class="form-group row">
                <label for="" class="col-12 col-md-3 text-center control-label">
                    Social Links </label>
                <div class="col-12 col-md-7">
                    <input type="text" class="form-control" name="fb_link" value="<?php echo isset($record->fb_link) ? $record->fb_link : set_value('fb_link'); ?>">
                    <span class="description">Facebook Profile Link</span>
                    <br>
                    <input type="text" class="form-control" name="twitter_link" value="<?php echo isset($record->twitter_link) ? $record->twitter_link : set_value('twitter_link'); ?>">
                    <span class="description">Twitter Profile Link</span>
                    <br>
                    <input type="text" class="form-control" name="googleplus_link" value="<?php echo isset($record->googleplus_link) ? $record->googleplus_link : set_value('googleplus_link'); ?>">
                    <span class="description">Google Plus Link</span>
                    <br>
                    <input type="text" class="form-control" name="Linkedin_link" value="<?php echo isset($record->Linkedin_link) ? $record->Linkedin_link : set_value('Linkedin_link'); ?>">
