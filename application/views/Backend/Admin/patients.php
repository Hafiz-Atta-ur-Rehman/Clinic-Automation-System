...
<section>
    <div class="container-fluid d-flex justify-content-end mb-3">
        <a href="<?= site_url('index.php/admin/addpatients');?>">
                        ...
                        <img src="<?= $record->icon; ?>" style="width:60px;height: 60px;">
                                ...
                                <td>
                                    <div class="btn-group d-block">
                                        <div class="container">
                                             <a href="<?= base_url('index.php/admin/edit_patient/').$record->id; ?>" class="btn btn-success btn-sm">
                                                <i class="fas fa-edit"></i>&nbsp;Edit
                                            </a>
                                            <a href="<?= base_url('index.php/admin/delete_patient/').$record->id; ?>" class="btn btn-danger btn-sm">
