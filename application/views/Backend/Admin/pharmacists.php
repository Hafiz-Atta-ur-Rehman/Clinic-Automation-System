...
@section(title)Pharmacists@endsection
@section(links)
<!-- SweetAlert2 -->
...
<section>
    <div class="container-fluid d-flex justify-content-end mb-3">
        <a href="<?= site_url('index.php/admin/addpharmacists'); ?>">
...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">Pharmacist List</h3>
                ...
                <tr>
                    <td class="d-flex justify-content-center">
                        <img src="<?= $record->icon; ?>" style="width:60px;height: 60px;">
                                ...
                                <td><?= $record->name;?></td>
                                <td><?= $this->Admin_model->get_login_details($record->id,'pharmacist')->email; ?></td>
                                <td><?= $record->phone;?></td>
                                <td><?= $record->address;?></td>
                    <td>
                                <a href="<?= base_url('index.php/admin/edit_pharmacist/').$record->id; ?>" class="btn btn-success btn-sm">
                    ...
                    <td>
                                <a href="<?= base_url('index.php/admin/delete_pharmacist/').$record->id; ?>" class="btn btn-danger btn-sm">
