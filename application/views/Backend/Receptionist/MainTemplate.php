        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element"> <span>
                            ...
                            <ul class="dropdown-menu animated fadeInRight m-t-xs">
                                ...
                                <li class="divider"></li>
                                <li><a href="<?= site_url('index.php/logout');?>">Logout</a></li>
                            </ul>
                        </div>
                    ...
                    <li class="@provide(payrollselected)">
                        <a href="<?=base_url('index.php/receptionist/payroll')?>"><i class="fa fa-flask"></i> <span class="nav-label">Payroll</span></a>
                    </li>
