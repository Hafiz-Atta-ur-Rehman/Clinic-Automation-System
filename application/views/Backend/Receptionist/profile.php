            ...
            <div class="tab-content">
                <div id="tab-1" class="tab-pane active">
                    <div class="panel-body">
                        <div class="col-lg-10 col-md-10 col-xs-10 col-xs-offset-1 col-md-offset-1 col-lg-offset-1">
                            <form role="form" class="form-horizontal form-groups" action="" method="post"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="email" name="email" class="form-control" id="field-1"
                                            value="doctor@example.com" required="">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea name="address" class="form-control "
                                            id="field-ta">Tempor distinctio At non iusto nulla nostrud </textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="number" name="phone" class="form-control" id="field-1"
                                            value="+984-46-9388638">
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-10 col-md-10 col-xs-10 col-xs-offset-1 col-md-offset-1 col-lg-offset-1">
                            <form role="form" class="form-horizontal form-groups" action="" method="post"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="password" name="name" class="form-control" id="field-1"
                                            value="Micheal Pewd" required="">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="password" name="name" class="form-control" id="field-1" value=""
                                            required="">
                                    </div>
                                </div>
                                <div class="form-group">
